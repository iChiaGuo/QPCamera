...
#import "QPCameraController.h"
#import <AVFoundation/AVFoundation.h>
#import <AssetsLibrary/AssetsLibrary.h>
#import "NSFileManager+QPAdditions.h"

NSString *const QPThumbnailCreatedNotification = @"QPThumbnailCreated";

@interface QPCameraController () <AVCaptureFileOutputRecordingDelegate>
...
@implementation QPCameraController
...
static const NSString *QPCameraAdjustingExposureContext;
            ...
            if ([device isExposureModeSupported:AVCaptureExposureModeLocked]) {
                [device addObserver:self
                         forKeyPath:@"adjustingExposure"
                            ...
                            context:&QPCameraAdjustingExposureContext];
            }
...
- (void)observeValueForKeyPath:(NSString *)keyPath
    ...
    if (context == &QPCameraAdjustingExposureContext) {
...
- (void)postThumbnailNotifification:(UIImage *)image {
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [nc postNotificationName:QPThumbnailCreatedNotification object:image];
    });
}
...
- (NSURL *)uniqueURL {
    ...
    NSString *dirPath =
        [fileManager temporaryDirectoryWithTemplateString:@"QPCamera.XXXXXX"];

    if (dirPath) {
        NSString *filePath =
            [dirPath stringByAppendingPathComponent:@"QPCamera_movie.mov"];
